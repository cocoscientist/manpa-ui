...
const HomePage = () => {
    ...
    return (
        <Box sx={{ width: '100%' , backgroundColor: '#FFD8B9'}}>
            <Box sx={{ backgroundColor: '#FFD8B9' }}>
            ...
            <Box sx={{ backgroundColor: '#F1E8FF', py: 4 }}>
                <Container maxWidth="lg">
                    <Box sx={{ py: 4, backgroundColor: '#F1E8FF' }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                            <Typography
                                variant="h4"
                                component="h2"
                ...
                <Container maxWidth="lg" sx={{ position: 'relative', mt: 4, backgroundColor: '#F1E8FF' }}>
                    <Box
                        sx={{
                            display: 'flex',
                            overflowX: 'auto',
