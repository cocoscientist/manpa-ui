...
const ArticleViewer = () => {
    ...
    return (
        <div className="article-viewer-container">
            <ArticleHeading title={articleData.title} credentials={articleData.credentials} image={articleData.bigImage?articleData.bigImage:undefined} light={articleData.light||articleData.lightImage} author={articleData.author}/>
